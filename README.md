...
6. **Runlevel/Target:** ในระบบปฏิบัติการ Linux จะมีสถานะ runlevel หรือ target เป็นตัวเลขตั้งแต่ 0-6 ซึ่งระบุสถานะการทำงานของระบบ จากนั้นโปรแกรม init จะโหลดการกำหนดค่าของ runlevel หรือ target และเริ่มต้นการเปิดบริการตามที่กำหนด
# Process Management
