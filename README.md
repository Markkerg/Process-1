...
1.  **System startup:**  เป็นขั้นตอนแรกที่เกิดขึ้นเมื่อทำการเปิดเครื่อง มันจ่ายไฟฟ้าให้กับส่วนประกอบหลักทำงาน เช่น BIOS,CMOS,UEFI ซึ่งโปรแกรมนี้จะทำการตรวจสอบฮาร์ดแวร์และสร้างการเชื่อมต่อเพื่อติดต่อกับอุปกรณ์ภายในเครื่องเพื่อทำให้เครื่องพร้อมรับคำสั่งต่อไป
...
เป็นระบบตัวจัดการ Task Scheduler ซึ่งใช้ในการทำงานตามตารางเวลาที่กำหนดไว้
...
เป็นงานหรือสคริปต์ที่ต้องการให้ระบบทำงานโดยตามตารางเวลาที่กำหนดไว้ ซึ่ง cron jobs จะถูกเก็บไว้ใน และจะถูก cron ตรวจสอบและเรียกใช้งานตามเวลาที่ระบุในตารางเวลา
...
|65070183 |นาย ภูวเดช อนันต์คูศรี|เพิ่มข้อมูล Boot Process, Process Management, Service Management|
