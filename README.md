...
1.  [**System startup:**](/BootProcess/SystemStartup/README.MD) เป็นขั้นตอนแรกที่เกิดขึ้นเมื่อทำการเปิดเครื่อง มันจ่ายไฟฟ้าให้กับส่วนประกอบหลักทำงาน เช่น BIOS,CMOS,UEFI ซึ่งโปรแกรมนี้จะทำการตรวจสอบฮาร์ดแวร์และสร้างการเชื่อมต่อเพื่อติดต่อกับอุปกรณ์ภายในเครื่องเพื่อทำให้เครื่องพร้อมรับคำสั่งต่อไป
...
เป็นงานหรือสคริปต์ที่ต้องการให้ระบบทำงานโดยตามตารางเวลาที่กำหนดไว้ ซึ่ง cron jobs จะถูกเก็บไว้ใน crontab และจะถูก cron ตรวจสอบและเรียกใช้งานตามเวลาที่ระบุในตารางเวลา
...
เมื่อเปิดแก้ไข Cron Job ในโปรแกรมที่คุณเลือก คุณจะเห็นหน้าตาของไฟล์ Cron ซึ่งเป็นรูปแบบของบรรทัดต่างๆ เกี่ยวกับการตั้งค่า Cron Job
...
เมื่อคุณเพิ่มคำสั่งเข้าไปในไฟล์ Cron ให้บันทึกและปิดโปรแกรมที่คุณใช้ในการแก้ไข เช่นถ้าใช้ nano กด Ctrl+X
