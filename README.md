...
2.  **Bootloader stage:** หลังจากขั้นตอนที่ 1 และสถานะของเครื่องปกติ ตัว BIOS,UEFI จะทำการ boot ตัว 
 storage ต่างๆ เพื่อหา bootloader ซึ่งจะทำหน้าที่เลือกและโหลดระบบปฏิบัติการที่จะเริ่มต้น เมื่อผู้ใช้เลือกระบบปฏิบัติการที่ต้องการเริ่มต้น โปรแกรมบูตโลดเดอร์จะโหลด kernel และ initramfs (ถ้ามี) ใน linux ก็จะมี bootloader หลักๆคือ 
> - LILO  (LInux LOader)
> -   SYSILINUX 
