...
## เริ่มต้น Setting Up a Cron Job

### 1.เริ่มการสร้าง Contrab file

ใช้คำสั่ง `crontab -e` หากเป็นการใช้ crontab ครั้งแรก ระบบให้เลือกโปรแกรมที่จะใช้ในการแก้ไข Cron Job เช่น nano, vi, ed

### 2.สร้าง Cron Job

เมื่อเปิดแก้ไข Cron Job ในโปรแกรมที่เลือก จะเห็นหน้าตาของไฟล์ Cron ซึ่งเป็นรูปแบบของบรรทัดต่างๆ เกี่ยวกับการตั้งค่า Cron Job การสร้าง Cron Job ทำได้โดยการเขียน cron job syntax
...
## การตรวจสอบสภานะของ Cron Job

สามารถทำได้โดยการใช้คำสั่ง `crontab -l` จะแสดง cron jobs ทั้งหมด ในรูปแบบ `* * * * * /path/to/script`
...
|65070230 |นาย สมิทธิพงศ์ จูปรางค์|บทคัดย่อ|
