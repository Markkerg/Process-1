...
> -   GRUB2 (GRand Unified Bootloader)
 ซึ่งโปรแกรมเหล่านี้จะทำหน้าที่เลือกและโหลดระบบปฏิบัติการที่จะเริ่มต้น เมื่อผู้ใช้เลือกระบบปฏิบัติการที่ต้องการเริ่มต้น โปรแกรมบูตโลดเดอร์จะโหลด kernel และ initramfs (ถ้ามี)
